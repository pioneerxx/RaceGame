# BrickGame Racing (Java)
Summary: In this project, you need to implement the Racing game in the Java programming language.

# Contents

- [BrickGame Races (Java)](#brickgame-racing)
  - [Contents](#contents)
...
The implementation of the Racing game in the Java programming language will consist of the development of several individual components: a library responsible for implementing the game logic, a web interface and a server providing REST API for accessing games via the network.
...
- Stick to Google Java Style Guide when writing code.
- The library that implements the game logic must be covered by unit tests using `JUnit` framework. - Pay special attention to checking the FMS states and transitions. The coverage of the library with game logic with tests must be at least 80 percent.
